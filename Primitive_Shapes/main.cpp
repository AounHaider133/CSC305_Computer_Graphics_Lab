...
//initialize material(for a specific object) property and light sources
void init(void)
{
...
void reshape(int w,int h)
{
    ...
    glLoadIdentity();
    if(w <= h)
        glOrtho(-2.5,2.5,-2.5*(GLfloat)h/(GLfloat)w,2.5*(GLfloat)h/(GLfloat)w,-1.0,10.0);
    else
        glOrtho(-2.5*(GLfloat)w/(GLfloat)h,2.5*(GLfloat)w/(GLfloat)h,-2.5,2.5,-1.0,10.0);
